...
question(
  ...
  ____(
    planet_moon = ____(
      ...
      ring ____ 'FALSE' ____ num_moon ____ 0 ~ 'terrestrial with moon'
    )
  ) %>%
  ...
  answer(
    ...
    for instance: if a planet is gaseous without moon is because it has ring and the number of moons is zero."
  ),
  answer(
    "`mutate ; case_when ; == ; | ; == ; == ; | ; == ; == ; | ; == ; == ; | ; ==`",
    correct = FALSE,
    message =  "- <i class='fas fa-check'></i> Incorrect! This makes that `gaseous without moon` and `gaseous with moon` are defined in the same way, which is wrong."
  ),
  answer(
    "`case_when ; mutate ; == ; & ; == ; == ; & ; == ; == ; & ; > ; == ; & ; >`",
    correct = FALSE,
